...
export default function Edit({ post: currentPost, categories, tags: suggestionsList, authors }) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        robots_index: currentPost.robots_index || 'index',
        robots_follow: currentPost.robots_follow || 'follow',
        schema_markup: currentPost.schema_markup || null,
        og_title: currentPost.og_title || '',
        og_description: currentPost.og_description || '',
        og_image: null,
        _method: 'POST', // Laravel file upload override
    });

    const [imagePreview, setImagePreview] = useState(currentPost.image || null);
    const [ogImagePreview, setOgImagePreview] = useState(currentPost.og_image || null);
    ...
    const handleSubmit = (e) => {
        ...
        post(route('blog.posts.update', currentPost.id), {
            forceFormData: true,
            onSuccess: () => {
            ...
            onError: (errs) => {
                ...
                toast.error(firstErr || 'Failed to update post.');
            }
        });
    };
    ...
    return (
        <>
            <Head title={`Edit Post: ${currentPost.title}`} />
            <AdminLayout>
                    ...
                    <div className="max-w-8xl mx-auto space-y-8">
                        ...
                        <div className="border-b border-gray-100 pb-5 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                            <div className="space-y-1">
                                ...
                                <Breadcrumbs items={[{ label: 'Blog', href: '/blog/posts' }, { label: 'Edit Post' }]} />
                            </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            <select
                                                ...
                                                className="w-full px-4 py-3 bg-gray-50 border-transparent rounded-2xl text-sm focus:bg-white focus:ring-2 focus:ring-indigo-500 outline-none transition-all appearance-none cursor-pointer font-bold text-gray-700"
                                            >
                                                    ...
                                                    <div className="grid grid-cols-2 gap-2">
                                                        <div className="space-y-1.5">
                                                            ...
                                                            <select
                                                                ...
                                                                className="w-full px-3 py-2 bg-gray-50 border-transparent rounded-xl text-[11px] font-semibold outline-none focus:bg-white focus:ring-2 focus:ring-indigo-500 transition-all cursor-pointer font-bold text-gray-600"
                                                            >
                                                    ...
                                                    <div className="space-y-4">
                                                        <div className="space-y-2">
                                                            ...
                                                            <input
                                                                ...
                                                                className="w-full px-4 py-2.5 bg-gray-50 border-transparent rounded-xl text-xs focus:bg-white focus:ring-2 focus:ring-indigo-500 outline-none transition-all font-semibold text-gray-700"
                                                            />
                                                        ...
                                                        <div className="space-y-2">
                                                            ...
                                                            <textarea
                                                                ...
                                                                className="w-full px-4 py-2.5 bg-gray-50 border-transparent rounded-xl text-xs focus:bg-white focus:ring-2 focus:ring-indigo-500 outline-none transition-all resize-none text-gray-700"
                                                            ></textarea>
                                                        </div>
                                                    </div>
